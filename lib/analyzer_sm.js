...
input: 
    item - json parsed item from getSite )resp.body from gethistogram steam site)
...
/*
input: array with objects with json parsed resp.body with histogram  + attributes .hash_name .nameid (assigned from input array)
